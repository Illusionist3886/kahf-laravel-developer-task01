...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule): void
    {
        ...
        $schedule->job(new UpdateVaccineCenterSchedule)->weeklyOn(1,2,3,6,7, '18:05')
                    ->after(function () {
                        $this->call('cache-user-vaccine-status');
                    }); // Runs on Monday, Tuesday, Wednesday, Saturday and Sunday.
